...
const FolioCard = (props) => {
  return (
    <Paper variant="outlined" sx={{ paddingY: 2, paddingX: 2 }}>
      <React.Fragment>
        <Stack direction='row' spacing={2} justifyContent='flex-start' alignItems='center' mb={1} >
          {/* <Typography sx={{ fontSize: 14 }} color="text.secondary" gutterBottom>
          Equity
        </Typography> */}


          <Chip label={props.data?.category?.value} size="small" />
          <Chip label={props.data?.plan} size="small" />
        </Stack>
